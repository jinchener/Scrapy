...
class LianjiaSpider(scrapy.Spider):
    ...
    def parse(self,response):
        ...
        #print pagenum
        if pagenum>=100:
            if response.xpath('/html/body/div[3]/div[2]/dl[2]/dd/div/div[2]/a[1]/@href'):
                ...
                for href in response.xpath('/html/body/div[3]/div[2]/dl[2]/dd/div/div/a/@href'):
                    url=response.urljoin(href.extract())
                    #print url
    ...
    def parse_list_page(self, response):
        ...
        for sel in response.xpath('/html/body/div[4]/div[1]/ul/li'):
            ...
            if len(info)==3:
                ...
                item['types']=''
                item['sales']=sel.xpath('div[1]/div[2]/a[1]/text()').extract()[0][5:-1]
                item['rents']=sel.xpath('div[1]/div[2]/a[2]/text()').extract()[0][:-5]
    ...
    def parse_page(self,response):
        ...
        if response.xpath('//div[@class="xiaoquInfo"]/div[9]/span[2]/span/text()').extract():
            item['shop']=response.xpath('//div[@class="xiaoquInfo"]/div[9]/span[2]/span/text()').extract()[0]
            item['shopadd']=response.xpath('//div[@class="xiaoquInfo"]/div[9]/span[2]/text()').extract()[0].replace('/','')
        else:
            item['shop']=response.xpath('//div[@class="xiaoquInfo"]/div[9]/span[2]/text()').extract()[0]
            item['shopadd']=''
        yield item
